...
VALUES (N'20181203122206_InitCreate', N'2.1.4-rtm-31024');

GO

ALTER TABLE [BusinessOwners] ADD [BusinessId] uniqueidentifier NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';

GO

ALTER TABLE [BusinessCashiers] ADD [BusinessId] uniqueidentifier NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';
...
ALTER TABLE [BusinessCashiers] ADD CONSTRAINT [FK_BusinessCashiers_Businesses_BusinessId] FOREIGN KEY ([BusinessId]) REFERENCES [Businesses] ([Id]) ON DELETE CASCADE;

GO

ALTER TABLE [BusinessOwners] ADD CONSTRAINT [FK_BusinessOwners_Businesses_BusinessId] FOREIGN KEY ([BusinessId]) REFERENCES [Businesses] ([Id]) ON DELETE CASCADE;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20181203124603_BusRelUpdate', N'2.1.4-rtm-31024');
